...
## EBOV dataset
Dataset of 15 Ebola virus (EBOV) genomes taken from [http://beast.community/ebov_local_clocks.html](http://beast.community/ebov_local_clocks.html), where the original references for the genomes can be found.
...
### Env dataset 
Dataset of 132 gp120 gene sequences. Aligned in AliView using MUSCLE, trimmed ends and insertions in only in one sequence and renamed sequence headers. Resulting alignment is 820 bp long. Processed, raw, and intermediate versions of the dataset are included.


### Pol dataset 
Dataset of 42 pol gene sequences. Aligned in AliView using MUSCLE, trimmed ends and renamed sequence headers. Resulting alignment is 689 bp long. Processed, raw, and intermediate versions of the dataset are included.
...
metadata are available from https://www.cogconsortium.uk/priority-areas/data-linkage-analysis/public-data-analysis/ (the COG-consortium website is no longer live, but available on the webarchive and British national archives).
...
1 August 2020 and 1 February 2021.
